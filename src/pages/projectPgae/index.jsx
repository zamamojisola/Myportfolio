...
const Projects = () => {
    ...
    return (
        ...
        <div className=" dark:bg-gray-800 w-full h-full border">
          <div className="w-[97%] min-h-[33rem] font-[Oswald]  m-auto mt-5 rounded-2xl bg-[#3c527d]  p-5 text-[#3c527d] grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 shadow-2xl shadow-blue-400 gap-3">
            {projectList.map((ele) => (
              <div
                key={ele.id}
